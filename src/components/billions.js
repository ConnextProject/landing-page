    ...
    render(){
        return(
            <div className="explainer" style={{textAlign:"center",
                ...
                <div className="explainer1"style={{ textAlign:"left", marginBottom:"20%"}}>
                    <h2 style={{
                    ...
                    We believe these transactions can be immensely valuable to creators, micromerchants,
                    and machines.
                </div>
                <div className="explainer2"style={{marginRight:"0%",textAlign:"left"}}>
                    <h2 style={{
                                fontFamily: "Comfortaa",
                                color:"#FCA311"}}>
                    Meet Connext
