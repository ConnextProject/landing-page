        ...
        <div className="viable">
          ...
          <div className="viable-text" style={{textAlign:"center",
            ...
            <div className="viable-block-1" style={{marginBottom:"6%"}}>
                <h4 style={{color:"#FCA311", fontWeight:"lighter", fontFamily:"'proxima-nova', sans-serif"}} >DEVELOPER FOCUSED</h4>
            ...
            <div className="viable-block" style={{marginBottom:"6%"}}>
                <h4 style={{color:"#FCA311", fontWeight:"lighter", fontFamily:"'proxima-nova', sans-serif"}} >TRUST-MINIMIZED</h4>
            ...
            <div className="viable-block" style={{marginBottom:"6%"}}>
              <h4 style={{color:"#FCA311", fontWeight:"lighter", fontFamily:"'proxima-nova', sans-serif"}} >OPEN SOURCE</h4>
