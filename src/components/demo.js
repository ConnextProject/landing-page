        ...
        return(
            <div style={{textAlign:"center",
                ...
                <div style={{marginBottom:"10%"}}>
                    ...
                    <p  className="subhead" style={{fontSize:"large", margin:"auto"}}>Let's walk through a typical payment flow</p>
                </div>
                <div className="step-wrapper" style={{display:"flex",}}>
                    <div className="step1card" style={{ 
